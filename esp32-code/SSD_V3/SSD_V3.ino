...
void  mainSSD(bool buzz) {
  ...
  if (moving) {
    ...
    kondisi = "Kepala terdeteksi bergerak";
    sendKondisi = "K0";
    digitalWrite(led1Pin, HIGH);
    servoMotor.write(0);
  }
  ...
  if (!moving) {
    ...
    if (isHeadBelowThreshold() == true && timeDiff > timerTidur * 1000){
      swipe();
      digitalWrite(led1Pin, HIGH);
      kondisi = "Menunduk terdeteksi, gerakkan kepala anda";
      sendKondisi = "K1";
    ...
    else if (isHeadBelowThreshold() == false && timeDiff > timerStandby * 1000)
    {
      swipe();
      digitalWrite(led1Pin, HIGH);
      kondisi = "Idle terdeteksi, gerakkan kepala anda";
      sendKondisi = "K2";
