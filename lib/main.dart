      ...
      body: Column(
        ...
        children: [
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: Container(
                      margin: EdgeInsetsDirectional.fromSTEB(35, 13, 10, 13),
                      height: 50,
                      decoration: BoxDecoration(
                  ...
                  Expanded(
                    child: Container(
                      margin: EdgeInsetsDirectional.fromSTEB(10, 13, 35, 13),
                      height: 50,
                      decoration: BoxDecoration(
                        color: Color(0xffE8DABB),
                        borderRadius: BorderRadius.circular(15),
          ...
          Container(
            width: 300,
            height: 40,
            margin: EdgeInsets.only(left: 35, right: 200), // memberikan margin pada sisi kanan
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(15),
              color: Color(0xffFDB004),
            ),
